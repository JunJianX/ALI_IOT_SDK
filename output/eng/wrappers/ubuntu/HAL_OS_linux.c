...
#define PLATFORM_WAIT_INFINITE (~0)
    ...
    char _product_key[IOTX_PRODUCT_KEY_LEN + 1]       = "a1kngHS9Po7a1kngHS9Po7";
    char _product_secret[IOTX_PRODUCT_SECRET_LEN + 1] = "";
    char _device_name[IOTX_DEVICE_NAME_LEN + 1]       = "nTXzz1KUaUSQrkJbfbMp";
    char _device_secret[IOTX_DEVICE_SECRET_LEN + 1]   = "toJcMTadKwLh2tUNgGEEghyQ0bGn9fwc";
#else
